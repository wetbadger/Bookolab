...
public interface ReactionRepository extends JpaRepository<Reaction, Long> {
     ...
     */
    @Query("SELECT COALESCE(SUM(CASE WHEN r.reactionType = com.bookolab.restservice.enums.ReactionType.LIKE THEN 1 " +
            "                         WHEN r.reactionType = com.bookolab.restservice.enums.ReactionType.DISLIKE THEN -1 " +
            "                         ELSE 0 END), 0) " +
            "FROM Reaction r " +

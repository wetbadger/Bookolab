...
//#endregion
//#region node_modules/@vue/reactivity/node_modules/@vue/shared/dist/shared.esm-bundler.js
/**
* @vue/shared v3.5.38
...
var MutableReactiveHandler = class extends BaseReactiveHandler {
	...
	set(target, key, value, receiver) {
		...
		if (!this._isShallow) {
			...
			if (!isArrayWithIntegerKey && /* @__PURE__ */ isRef$1(oldValue) && !/* @__PURE__ */ isRef$1(value)) if (isOldValueReadonly) {
...
function createReactiveObject(target, isReadonly2, baseHandlers, collectionHandlers, proxyMap) {
	...
	const targetType = targetTypeMap(toRawType$1(target));
...
function watch$1(source, cb, options = EMPTY_OBJ$2) {
	...
	const job = (immediateFirstRun) => {
		...
		if (cb) {
			...
			if (immediateFirstRun || deep || forceTrigger || (isMultiSource ? newValue.some((v, i) => hasChanged$1(v, oldValue[i])) : hasChanged$1(newValue, oldValue))) {
				if (cleanup) cleanup();
	...
	const res = customRef((track, trigger) => {
		...
		return {
			...
			set(value) {
				...
				if (hasChanged(value, prevSetValue) && (hasChanged(value, emittedValue) && !hasChanged(emittedValue, prevEmittedValue) || hasVModel && prevSetValue !== EMPTY_OBJ$1 && !hasChanged(emittedValue, localValue))) trigger();
				prevSetValue = value;
...
//#endregion
export { createStaticVNode as $, readonly as $n, resolveFilter as $t, DeprecationTypes as A, normalizeProps as An, onActivated as At, callWithAsyncErrorHandling as B, effectScope as Bn, onUnmounted as Bt, vModelText as C, withDefaults as Cn, isMemoSame as Ct, BaseTransition as D, camelize$1 as Dn, mergeModels as Dt, withModifiers as E, withScopeId as En, mergeDefaults as Et, Static as F, ReactiveEffect as Fn, onErrorCaptured as Ft, createBaseVNode as G, isReadonly as Gn, pushScopeId as Gt, cloneVNode as H, getCurrentWatcher as Hn, openBlock as Ht, Suspense as I, TrackOpTypes as In, onMounted as It, createElementBlock as J, markRaw as Jn, renderList as Jt, createBlock as K, isRef$1 as Kn, queuePostFlushCb as Kt, Teleport as L, TriggerOpTypes as Ln, onRenderTracked as Lt, ErrorTypeStrings as M, toDisplayString as Mn, onBeforeUnmount as Mt, Fragment as N, toHandlerKey$1 as Nn, onBeforeUpdate as Nt, BaseTransitionPropsValidators as O, capitalize$1 as On, mergeProps as Ot, KeepAlive as P, EffectScope as Pn, onDeactivated as Pt, createSlots as Q, reactive as Qn, resolveDynamicComponent as Qt, Text as R, customRef as Rn, onRenderTriggered as Rt, vModelSelect as S, withCtx as Sn, inject as St, withKeys as T, withMemo as Tn, isVNode as Tt, compatUtils as U, isProxy as Un, popScopeId as Ut, callWithErrorHandling as V, getCurrentScope as Vn, onUpdated as Vt, computed as W, isReactive as Wn, provide as Wt, createPropsRestProxy as X, onWatcherCleanup as Xn, resolveComponent as Xt, createHydrationRenderer as Y, onScopeDispose as Yn, renderSlot as Yt, createRenderer as Z, proxyRefs as Zn, resolveDirective as Zt, useHost as _, watch as _n, hydrateOnIdle as _t, VueElement as a, ssrUtils as an, toRaw as ar, defineExpose as at, vModelDynamic as b, watchSyncEffect as bn, hydrateOnVisible as bt, defineCustomElement as c, useAttrs as cn, toValue as cr, defineProps as ct, initDirectivesForSSR as d, useSSRContext as dn, getCurrentInstance as dt, resolveTransitionHooks as en, ref as er, createTextVNode as et, nodeOps as f, useSlots as fn, getTransitionRawChildren as ft, useCssVars as g, warn as gn, hasInjectionContext as gt, useCssModule as h, version as hn, handleError as ht, TransitionGroup as i, ssrContextKey as in, stop as ir, defineEmits as it, ErrorCodes as j, normalizeStyle as jn, onBeforeMount as jt, Comment as k, normalizeClass as kn, nextTick as kt, defineSSRCustomElement as l, useId as ln, triggerRef as lr, defineSlots as lt, render as m, useTransitionState as mn, h as mt, vue_runtime_esm_bundler_exports as n, setDevtoolsHook as nn, shallowReadonly as nr, defineAsyncComponent as nt, createApp as o, toHandlers as on, toRef as or, defineModel as ot, patchProp as p, useTemplateRef as pn, guardReactiveProps as pt, createCommentVNode as q, isShallow as qn, registerRuntimeCompiler as qt, Transition as r, setTransitionHooks as rn, shallowRef as rr, defineComponent as rt, createSSRApp as s, transformVNodeArgs as sn, toRefs as sr, defineOptions as st, compile as t, setBlockTracking as tn, shallowReactive as tr, createVNode as tt, hydrate as u, useModel as un, unref as ur, devtools as ut, useShadowRoot as v, watchEffect as vn, hydrateOnInteraction as vt, vShow as w, withDirectives as wn, isRuntimeOnly as wt, vModelRadio as x, withAsyncContext as xn, initCustomFormatter as xt, vModelCheckbox as y, watchPostEffect as yn, hydrateOnMediaQuery as yt, assertNumber as z, effect as zn, onServerPrefetch as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-BIab_n9Q.js.map